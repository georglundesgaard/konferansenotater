...
4. **Oppdater `program.md`.** Behold formatet: én tabell per dag med kolonnene Tid, Rom, Lengde, Språk, Foredrag, Taler(e) og tema, og et anker `d<dag>-<hhmm>-room-<n>` i hver Tid-celle. Oppdater hentedatoen øverst.
