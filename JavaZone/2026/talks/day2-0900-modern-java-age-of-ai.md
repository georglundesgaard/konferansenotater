...
Saab, SVP for Java i Oracle og styreleder i OpenJDK, ga en statusrapport for Java i 2026: seksmåneders-releasemodellen leverer 8 til 20 nye funksjoner og 2000 til 2800 fikser per versjon, JDK 27 kommer uken etter foredraget, og utviklingen skjer helt åpent i OpenJDK-fellesskapet der Oracle er største, men langt fra eneste, bidragsyter. Funksjoner utvikles nå iterativt i mindre biter. Pattern matching og lambdas ble brukt som eksempler på at tålmodig forenkling gir løsninger som føles naturlige i språket.
