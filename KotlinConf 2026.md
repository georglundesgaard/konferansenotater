...
> **Om videoene:** Konferansen ble ferdig 22. mai 2026. Enkeltvideoer publiseres fortløpende på [Kotlin sin offisielle YouTube-kanal](https://www.youtube.com/@Kotlin) i løpet av de neste 1–2 månedene. Foreløpig (per 26. mai 2026) ligger åpnings-keynoten og Day 2-livestreamen ute; jeg legger inn lenker til individuelle videoer under hvert foredrag når de dukker opp.
...
### 0900 Opening Keynote — JetBrains
...
**Tags:** `Keynote` · `Kotlin 2.4` · `AI` · `Koog` · `ACP` · `Junie`
...
### 1300 How google.com/search builds on Kotlin coroutines for highly scalable, streaming, concurrent servers — Google Search Infra
...
**Tags:** `Språkdesign` · `Kotlin 2.4` · `Dypdykk`
...
**Tags:** `AI` · `AI-agenter` · `Koog` · `Testing` · `Evaluering`
...
**Tags:** `Språkdesign` · `Kotlin 2.4` · `API-design` · `Context parameters`
...
**Tags:** `Lyntale` · `gRPC` · `kotlinx-rpc` · `Backend`
...
**Tags:** `Gradle` · `DSL` · `Build tools` · `Historikk`
...
**Tags:** `Performance` · `JVM` · `Kotlin/Native` · `Kotlin/Wasm`
...
**Tags:** `Data Science` · `Kotlin Notebook` · `DataFrame` · `Kandy`
...
**Tags:** `Lyntale` · `KMP` · `iOS` · `SwiftPM` · `Tooling`
...
**Tags:** `KMP` · `iOS` · `SwiftUI` · `Skala` · `Casestudie`
...
**Tags:** `Amper` · `Build tools` · `JetBrains` · `Tooling`
...
**Tags:** `Lyntale` · `Compose` · `Kreativt` · `Rendering`
...
**Tags:** `AI` · `Kodekvalitet` · `Meta` · `Skala`
...
**Tags:** `KMP` · `iOS` · `Swift interop` · `Språkdesign`
...
**Tags:** `Tooling` · `Refaktorering` · `OpenRewrite` · `Kotlin 2`
...
**Tags:** `KMP` · `Kotlin/Native` · `Build tools` · `Avansert`
...
**Tags:** `Gradle` · `Build tools` · `Declarative` · `KMP`
...
**Tags:** `Språkdesign` · `Value classes` · `Immutability` · `Performance`
...
**Tags:** `AI` · `ML` · `KMP` · `On-device` · `SKaiNET`
...
**Tags:** `Lyntale` · `Språkdesign` · `JVM` · `Compile-time`
...
**Tags:** `Kotlin/Native` · `iOS` · `Compose` · `Hot reload` · `Compiler`
...
**Tags:** `AI` · `Koog` · `MCP` · `Compose Multiplatform` · `Full-stack`
...
**Tags:** `KMP` · `iOS` · `Compose Multiplatform` · `Swift interop` · `Casestudie`
...
**Tags:** `Exposed` · `Database` · `Flow` · `Coroutines` · `DataFrame`
...
**Tags:** `Backend` · `Ktor` · `Resilience` · `Observability` · `Feilhåndtering`
...
**Tags:** `MCP` · `http4k` · `Funksjonell` · `Backend` · `API-design`
...
**Tags:** `Testing` · `TestBalloon` · `KMP` · `Wasm`
...
**Tags:** `Koin` · `DI` · `Compiler plugin` · `Compile-time`
...
**Tags:** `Testing` · `Power-Assert` · `Kotlin 2.4` · `Compiler plugin`
