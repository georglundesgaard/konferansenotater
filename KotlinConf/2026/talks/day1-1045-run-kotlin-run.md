...
*[← KotlinConf 2026](../README.md) · Dag 1, 21. mai 2026 · kl 10:45 · Marc Reichelt*
...
Fra utviklerverktøyene demonstrerer han IntelliJ scratch files, `.kts`-skript kjørt både fra IDE-en og fra `kotlin`-kommandolinjen, og til og med `.kts`-filer gjort kjørbare med shebang. Til slutt bruker han samme felles modul til å starte iOS-appen fra Android Studio og til å drive SwiftUI-previews i Xcode. Poenget er ikke ytelsestall eller binærstørrelser, men en energisk feiring av hvor mange kjøremåter Kotlin har fått – hver nye demo markert med et bjelleslag.
