...
For feilhåndtering anbefaler han typede feil via Arrow sin Raise-DSL i stedet for kastede exceptions, slik at forretningsfeil blir en del av signaturen og kan mappes eksplisitt til HTTP-statuskoder i rutelaget. Han viser en domenesentrert lagdeling der ruter er tynne, tjenester og repositories holder logikken, og persistens gjøres med SqlDelight og KotlinX Serialization; strukturert samtidighet fra coroutines brukes samtidig til å håndtere ressurslivssyklus og graceful shutdown. Testing baseres på TestContainers og at man kan mocke enkeltavhengigheter uten å røre resten av grafen.
