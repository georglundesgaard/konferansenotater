...
**I pausene** tok registreringen noen minutter: `/nytt-foredrag brodwall el kam` finner riktig foredrag i cachen ut fra noen få bokstaver av navnene, spør om to ting (deltatt/ønskeliste og tags) og skriver fil, indeks og programrad med toveis lenking. Notatene limte jeg inn som stikkord etterpå. De er fredet: Ingen agent får røre dem.
